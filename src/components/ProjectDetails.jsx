...
const ProjectDetails = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-hidden backdrop-blur-sm">
      <motion.div initial={{opacity:0, scale:0.05}} animate={{opacity:1,scale:1}} className="relative max-w-2xl border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/50">
        ...
        <img src={image} alt={title} className="w-full rounded-t-2xl"></img>
        <div className="p-5">
